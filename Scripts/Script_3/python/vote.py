...
opener.addheaders.append( ('Referer', 'http://culinaryvoice.ice.edu/culinaryvoice/r4dBLFN') )
...
voting_data = urllib.urlencode({
'entry_id' : '102'
})
resp = opener.open('http://culinaryvoice.ice.edu/culinaryvoice/vote', voting_data)
