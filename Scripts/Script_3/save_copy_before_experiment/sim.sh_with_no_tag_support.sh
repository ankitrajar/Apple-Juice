...
if [ $number_of_parameters -ne "2" ] && [ "$first_input_string" != "$evolution_mode_string" ];then
...
su \$user -c \"source \$scripts_path/checkoutnm_simulator.sh \$checkout_path \$checkout_branch_name \$home_path \$cm_utils_path \$tj100_mc_diff_file_path \$tj100_mc_diff_file_name\";
