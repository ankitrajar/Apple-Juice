...
su_user="root";
home_path="/parmil"; ####home_path="$parent_path_of_checkout_path"; #<#<#$HOME#>#>#
cm_utils_path="/home/parmil"; ####cm_utils_path="$your_cm_utils_path"; #<#<#$HOME#>#>#
...
tgz_file_name="xcc360g-ppc-REL_10_0_0_a15_1.tgz"; #used for sidepanel fix script.
tgz_file_full_path="/home/swtn100/releases/REL_10_0_0/a_x/a15_1/builds/$tgz_file_name"; #used for sidepanel fix script.
...
+ADDED_C++FLAGS = 
 ...
 ################################################################################
diff --git a/src/app/tj1700/nm/impl/tj1700Shelf.cpp b/src/app/tj1700/nm/impl/tj1700Shelf.cpp
index 5b725cc..e45e703 100755
--- a/src/app/tj1700/nm/impl/tj1700Shelf.cpp
+++ b/src/app/tj1700/nm/impl/tj1700Shelf.cpp
@@ -397,9 +397,8 @@ void TJ1700ShelfImpl::createSimulatedCards(const string & /* nodeConfStr */)
...
@@ -416,7 +415,6 @@ void TJ1700ShelfImpl::createSimulatedCards(const string & /* nodeConfStr */)
         }
         {
...
-            Handle<Card> hCEF5Card;
             ...
             hCEF5Card = getCard(2);
             hElan04Card = DYNAMIC_CAST<Card, Card_ELAN04>(hCEF5Card);
@@ -433,7 +431,6 @@ void TJ1700ShelfImpl::createSimulatedCards(const string & /* nodeConfStr */)
...
-            Handle<Card> hCEF5Card;
             ...
             hCEF5Card = getCard(3);
             hElan04Card = DYNAMIC_CAST<Card, Card_ELAN04>(hCEF5Card);
@@ -448,9 +445,23 @@ void TJ1700ShelfImpl::createSimulatedCards(const string & /* nodeConfStr */)
...
+       // createMibCard(7, Card::card_AGG40, nullString, true);
         ...
         Handle<Card> hCard;
@@ -485,15 +496,27 @@ void TJ1700ShelfImpl::createSimulatedCards(const string & /* nodeConfStr */)
...
+            hElan04Card->setNumOfVCGPorts(0);
             ...
             hElan04Card->setNumOfTwistedPairPorts(16);
             tjAssertMessage(hElan04Card->verify(), __FUNCTION__
@@ -502,6 +525,8 @@ void TJ1700ShelfImpl::createSimulatedCards(const string & /* nodeConfStr */)
         }
